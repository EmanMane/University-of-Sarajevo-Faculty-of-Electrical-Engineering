...
--notOK - ne možemo unijeti red jer tabela ima ogranicenje da cijeli broj (4. kolona) mora biti unique, a vec postoji red u tabli sa vrjednoscu 1 u navedenoj koloni.
...
Drop table tabelaB;
--notOK - ne možemo uraditi Drop jer se strani kljuc koji je povezan sa primarnim kljucem tabele nalazi u tabeli C.
