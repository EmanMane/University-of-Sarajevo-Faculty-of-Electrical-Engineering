...
class Student{
    ...
    ~Student(){delete s;}
    Student():s(nullptr){}
    Student(const ApstraktniStudent &student){
        s=student.DajKopiju();
    }
    Student(const Student &student){
        if(!student.s) s=nullptr;
        s=student.s->DajKopiju();
    }
    ...
    Student &operator=(const Student &student){
        ApstraktniStudent *pom={};
        if(student.s!=nullptr) pom=student.s->DajKopiju();
        delete s;
        s=pom;
        return *this;
    }
    Student &operator=(Student &&student){
        std::swap(s,student.s); return *this;
    }
