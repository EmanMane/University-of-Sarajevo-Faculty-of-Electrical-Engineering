...
class BinStabloMapa : public Mapa<TipKljuca,TipVrijednosti>{
    int vel=0;
    Cvor<TipKljuca,TipVrijednosti> *vrh=nullptr;
    public:
    ...
    void obrisi(const TipKljuca &x){
        ...
        //Potraga za cvorom
        Cvor<TipKljuca,TipVrijednosti> *pom=vrh,*pom_dijete=nullptr,*pom_roditelj=nullptr;
        ...
        if(pom->l_dijete==nullptr) pom_dijete=pom->d_dijete; //prvi slucaj: ako ne postoji lijevo dijete ili ako ne postoji niti jedno
            ...
            if(pom->d_dijete==nullptr) pom_dijete=pom->l_dijete; //drugi slucaj: ako ne postoji desno dijete
                ...
                Cvor<TipKljuca,TipVrijednosti> *dijete_pom_djeteta=pom_dijete->d_dijete,*p=pom;
    ...
    TipVrijednosti &operator [](TipKljuca kljuc){
        ...
        if(pom==nullptr){
            ...
            TipVrijednosti vrijednost=TipVrijednosti();
            pom=new Cvor<TipKljuca,TipVrijednosti>;
    ...
    void kopiranje(Cvor<TipKljuca,TipVrijednosti> *pom){
        if(pom!=nullptr){
            (*this)[pom->k]=pom->v;
...
void test_brzine(){
    ...
    std::cout<<"Dodavanje 10 000 - og elementa u:\nNizMapu:  "<<(float)(t2-t1)/(CLOCKS_PER_SEC/1000)<<"\nBinStabloMapu: "<<(float)(t4-t3)/(CLOCKS_PER_SEC/1000)<<std::endl;
    std::cout<<"Pristup 7 577 - om elementu u:\nNizMapi:  "<<(float)(t6-t5)/(CLOCKS_PER_SEC/1000)<<"\nBinStabloMapi: "<<(float)(t8-t7)/(CLOCKS_PER_SEC/1000)<<std::endl;
}

//BinStabloMapa znatno brza u oba testa sto je donekle i ocigledno obzirom da su kljucevi randomizirani odnosno nasumicni kao sto se i trazilo
